...
public class CarPanel extends JPanel {
    ...
    private String formatCarInfo(Car car) {
        ...
        sb.append("Марка: ").append(car.getBrand()).append("\n");
        sb.append("Модель: ").append(car.getModel()).append("\n");
        sb.append("Рік: ").append(car.getYear()).append("\n");
        sb.append("Пробіг: ").append(car.getMileage()).append(" км\n");
        sb.append("Ціна за день: ").append(car.getPricePerDay()).append(" грн\n");
        return sb.toString();
    }

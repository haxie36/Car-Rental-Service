...
public class ClientPanel extends JPanel {
    ...
    private String formatClientInfo(Client client) {
        ...
        sb.append("Ім'я: ").append(client.getName()).append("\n");
        sb.append("Телефон: ").append(client.getPhone()).append("\n");
        sb.append("Кількість оренд: ").append(client.getRentalCount()).append("\n");
        sb.append("Активні оренди: ").append(client.hasActiveRentals() ? "Так" : "Ні");
        return sb.toString();
    }

    private String formatRentalInfo(Rental rental) {
        StringBuilder sb = new StringBuilder();
        sb.append("ID оренди: ").append(rental.getId()).append("\n");
        sb.append("Автомобіль: ").append(rental.getCarId()).append("\n");
        sb.append("Період: ").append(rental.getStartDate()).append(" - ").append(rental.getEndDate()).append("\n");
        sb.append("Тривалість: ").append(rental.totalDays()).append(" дн.\n");
        sb.append("Вартість: ").append(String.format("%.2f", rental.getTotalPrice())).append(" грн\n");
        sb.append("Статус: ").append(rental.isActive() ? "Активна" : "Завершена/запланована");
        return sb.toString();
    }
